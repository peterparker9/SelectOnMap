...
public class PlaceArrayAdapter extends ArrayAdapter<PlaceArrayAdapter.PlaceAutocomplete> implements Filterable {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView txtRecent = (TextView) row.findViewById(R.id.txtRecent);
        TextView txtAddress = (TextView) row.findViewById(R.id.txtAddress);
        String searchItem = mResultList.get(position).toString();

        txtRecent.setText(searchItem);
        txtAddress.setText(mResultList.get(position).description);
